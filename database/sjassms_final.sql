...
('school_email',         'mihretu.yangu@bru.edu.et',           'general','Contact email'),
...
-- Email / SMTP
('smtp_provider',        'google_workspace','email','Email provider: gmail|google_workspace|outlook|yahoo|custom'),
...
('smtp_user',            'mihretu.yangu@bru.edu.et', 'email','SMTP username / email address'),
('smtp_pass',            '',                         'email','SMTP password or app password'),
('smtp_from_email',      'mihretu.yangu@bru.edu.et', 'email','From email (blank = use smtp_user)'),
